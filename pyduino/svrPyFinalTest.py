...
def radiusBasedGrading(threadPrev=None, filenn="TestradBasedGrading", imagerDelay=1.5,camera=False, A=[50, 62.5], B=[62.5, 68.5], C=[68.5, 75], convFactor=2.2):
	"""
	...
	rad = radFinder(image,verbosity=0)
...
if __name__ == '__main__':
	...
	imagerDelay=4 #Used to fine tune the position of the fruit on the conveyer when image is taken.
	filenn="0"
